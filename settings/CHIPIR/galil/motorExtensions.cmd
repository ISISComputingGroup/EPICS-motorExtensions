...
$(IFIOC_GALIL_02) dbLoadRecords("$(MOTOREXT)/db/chipir_collimator.db", "P=$(MYPVPREFIX)MOT:COL:,D=DMC$(CNUM_PADDED),MOVE_THREAD=3,SEND_CMD=IN:CHIPIR:MOT:DMC02:SEND_STR_CMD")
