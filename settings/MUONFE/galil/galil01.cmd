...
#GalilStartController("Galil","$(GALIL)/db/galil_Default_Header.gmc;$(GALIL)/gmc/galil_Muon_Slits.gmc;$(GALIL)/gmc/galil_Default_Footer.gmc",0,0,3)
#GalilStartController("Galil","$(GALIL)/db/galil_Default_Header.gmc;$(GALIL)/gmc/galil_Home_Thread.gmc!$(GALIL)/gmc/galil_Home_Home.gmc!$(GALIL)/gmc/galil_Home_Home.gmc!$(GALIL)/gmc/galil_Home_Home.gmc!$(GALIL)/gmc/galil_Home_ForwLimit.gmc!$(GALIL)/gmc/galil_Muon_Slits.gmc;$(GALIL)/db/galil_Default_Footer.gmc",0,0,0)
#GalilStartController("Galil","$(GALIL)/gmc/galil_Default_Header.gmc;$(GALIL)/gmc/galil_Home_Thread.gmc!$(GALIL)/gmc/galil_Home_Home.gmc!$(GALIL)/gmc/galil_Home_Home.gmc!$(GALIL)/gmc/galil_Home_Home.gmc!$(GALIL)/gmc/galil_Home_ForwLimit.gmc;$(GALIL)/gmc/galil_Default_Footer.gmc!$(GALIL)/gmc/galil_Muon_Slits.gmc",0,0,3)
GalilStartController("Galil","$(GALIL)/gmc/galil_Default_Header.gmc;$(GALIL)/gmc/galil_Home_No_Home.gmc!$(GALIL)/gmc/galil_Home_No_Home.gmc!$(GALIL)/gmc/galil_Home_No_Home.gmc!$(GALIL)/gmc/galil_Home_ForwLimit.gmc;$(GALIL)/gmc/galil_Default_Footer.gmc!$(GALIL)/gmc/galil_Muon_Slits.gmc",0,0,3)
