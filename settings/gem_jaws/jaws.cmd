...
$(IFIOC_LINMOT_01) dbLoadRecords("$(MOTOREXT)/db/gemjawset.db", "P=$(MYPVPREFIX)MOT:, RECSIM=$(RECSIM), JAWS=JAWS6:, N_MTR=MTR0101, S_MTR=MTR0102, W_MTR=MTR0103, E_MTR=MTR0104")
