## configure galil crate 4 - Wish Galil 4
...
GalilCreateController("Galil", "$(GALILADDR)", 100, 1)
...
epicsEnvSet "HOME_MODE_1" "$(GALIL)/gmc/galil_Home_Home.gmc"
...
epicsEnvSet "ORC" "$(GALIL)/gmc/galil_Oscillating_Collimator_Wish.gmc"

GalilStartController("Galil","$(HOME_HEADER);$(HOME_MODE_1)!$(HOME_MODE_2)!$(HOME_MODE_3)!$(HOME_MODE_4)!$(HOME_MODE_5)!$(HOME_MODE_6)!$(HOME_MODE_7)!$(HOME_MODE_8);$(HOME_FOOTER)!$(ORC)",0,0,7)
