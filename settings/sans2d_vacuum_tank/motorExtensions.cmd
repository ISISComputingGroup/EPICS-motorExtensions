...
$(IFIOC_GALILMUL_02) dbLoadRecords("$(MOTOREXT)/db/sans2d_vac_tank.db", "P=$(MYPVPREFIX)MOT:,SANS2D_VACUUM_TANK_INTERVAL_MINOR_WARNING=100.0,SANS2D_VACUUM_TANK_INTERVAL_MAJOR_WARNING=50.0")
