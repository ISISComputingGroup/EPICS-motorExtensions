...
#epicsEnvSet "HOME_MODE_1" "$(GALIL)/gmc/galil_Home_Dummy_Do_Nothing.gmc" #XQ #HmHt,2
#epicsEnvSet "HOME_MODE_2" "$(GALIL)/gmc/galil_Home_Dummy_Do_Nothing.gmc" #XQ #HmHt,2
#epicsEnvSet "HOME_MODE_3" "$(GALIL)/gmc/galil_Home_RevLimit.gmc"
#epicsEnvSet "HOME_MODE_4" "$(GALIL)/gmc/galil_Home_Dummy_Do_Nothing.gmc" #XQ #HmArc,4
