...
GalilStartController("Galil","$(GALIL)/gmc/galil_Default_Header.gmc;$(GALIL)/gmc/galil_Home_Home.gmc!$(GALIL)/gmc/galil_Home_FORWLimit_Home.gmc!$(GALIL)/gmc/galil_Home_FORWLimit_Home.gmc!$(GALIL)/gmc/galil_Home_FORWLimit_Home.gmc!$(GALIL)/gmc/galil_Home_FORWLimit_Home.gmc!$(GALIL)/gmc/galil_Home_FORWLimit.gmc!$(GALIL)/gmc/galil_Home_FORWLimit.gmc!$(GALIL)/gmc/galil_Home_Home.gmc;$(GALIL)/gmc/galil_Default_Footer.gmc",0,0,3)
